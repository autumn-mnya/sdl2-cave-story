...
class RenderBackend
{
	...
	friend void* GetSurf();
	friend void PutBitmap3A(const RECT* rcView, int x, int y, const RECT* rect, int surf_no, Uint8 alpha, double angle, Uint32 color, bool flip_x, bool flip_y);
...
extern void PutBitmap3A(const RECT* rcView, int x, int y, const RECT* rect, int surf_no, Uint8 alpha, double angle, Uint32 color, bool flip_x, bool flip_y);
